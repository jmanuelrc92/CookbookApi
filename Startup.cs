...
namespace CookBook_Api
{
	public class Startup
	{
		...
		{
			services.Configure<RecipeSettings>
				(Configuration.GetSection(nameof(RecipeSettings)));

			services.AddSingleton<IRecipeSettings>
				(d => d.GetRequiredService<IOptions<RecipeSettings>>().Value);
